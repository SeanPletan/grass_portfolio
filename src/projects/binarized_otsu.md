...
![histogram graph](/otsus_histogram.png)
...
![A .gif showing the inter-class variance of an image's brightness values, as it is being scanned. ie. Otsu's Method](/otsus_method_visualization.gif)
...
![a grayscale image of red blood cells under a microscope](/otsus_input.png)
The input image (128x128). This is a photo of a red blood cell sample.

![a binarized version of the red blood cells image](/binarized.jpg)
...
![a binarized image where each red blood cell has its center marked, and is counted](/otsus_blob_counted.jpg)
